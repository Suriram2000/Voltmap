...
void main() {
  testWidgets('iPhone users receive only the Apple App Store action', (
    tester,
  ) async {
  ...
  testWidgets('Android install prompt reports acceptance and installed state', (
    ...
    expect(find.text('Get VoltMapEV for Android'), findsOneWidget);
    expect(find.byKey(const Key('openGooglePlayButton')), findsOneWidget);
